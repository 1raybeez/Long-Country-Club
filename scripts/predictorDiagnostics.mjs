...
const outputDirectory = mkdtempSync(join(tmpdir(), "lcc-predictor-"));

try {
  const compile = spawnSync(
    localTsc,
    [
      "scripts/predictorDiagnostics.ts",
      "--outDir",
      outputDirectory,
      "--module",
      "commonjs",
  ...
  require(join(outputDirectory, "scripts", "predictorDiagnostics.js"));
} finally {
