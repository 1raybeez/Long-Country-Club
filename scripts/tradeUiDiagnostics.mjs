...
required(dynastyOutlook, ["Dynasty Outlook", "How this trade fits each franchise", "Trade Fit", "Confidence", "Direction", "Long-term", "Win-now", "Evidence", "does not declare a winner"], "dynasty outlook");
