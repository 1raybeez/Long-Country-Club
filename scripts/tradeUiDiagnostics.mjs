...
required(compact, ["+ Add Asset", "Close picker", "Search roster and picks", "Search by player or pick", "Filter assets", "max-h-64", "overflow-y-auto", "selectedAssets", "Choose destination", "Remove", "Select", "!selected.has", "sortCompactAssets(owned)", "positionRank", "marketValue", "leftPick !== rightPick", "left.season", "left.round", "left.slot", "slice(0, 40)", "asset.assetType === \"DST\""], "compact multi-team picker");
