...
const outputDirectory = mkdtempSync(join(tmpdir(), "lcc-war-room-draft-capital-"));

try {
  const compile = spawnSync(localTsc, [
    "scripts/warRoomDraftCapitalDiagnostics.ts",
  ...
  require(join(outputDirectory, "scripts", "warRoomDraftCapitalDiagnostics.js"));
} finally {
