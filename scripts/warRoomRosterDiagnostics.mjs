...
const outputDirectory = mkdtempSync(join(tmpdir(), "lcc-war-room-roster-"));

try {
  const compile = spawnSync(localTsc, [
    "scripts/warRoomRosterDiagnostics.ts",
  ...
  require(join(outputDirectory, "scripts", "warRoomRosterDiagnostics.js"));
} finally {
